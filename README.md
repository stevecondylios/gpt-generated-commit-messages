...
Demo: All of the [commit messages](https://github.com/stevecondylios/gpt-generated-commit-messages#readme) for this project were generated by ChatGPT (except the first one). It works on any project (repo) and setup is quick. 
